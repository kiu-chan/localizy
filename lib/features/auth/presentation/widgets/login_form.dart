...
/// Phần "đăng nhập" của [LoginPage] — logo và nền do trang bao ngoài dựng.
class LoginForm extends ConsumerStatefulWidget {
  ...
  /// Chuyển sang form đăng ký (không mở trang mới).
  final VoidCallback onSwitchToRegister;

  /// Chuyển sang form quên mật khẩu (không mở trang mới).
